...
import kr.or.dgit.post.dao.Dao;
import kr.or.dgit.post.util.Config;
import kr.or.dgit.post.util.DBCon;
import kr.or.dgit.post.util.JdbcUtil;
...
public class InitSettingService {
	public void initSetting() {
		...
		try {
			...
			dao.getUpdateResult(Config.CREATE_SQL_POST);
			loadPostData();
			createIndex();
